...
class UserController {
  ...
  static async createUser(req, res) {
    const {
      firstName, lastName, address, email, password, jobRole, gender, dept,
    } = req.body;
    const query = `INSERT INTO
      users(id,firstName,lastName,address,email,jobRole,gender,dept,password)
      VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9)
      RETURNING id,firstName,lastName,address,email,jobRole,gender,dept`;
